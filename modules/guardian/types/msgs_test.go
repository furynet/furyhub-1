...
func TestMsgAddSuperGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"gridiron/guardian/MsgAddSuper","value":{"added_by":"did:fury:aa1pgm8hyk0pvphmlvfjc8wsvk4daluz5tgwp4wlf","address":"did:fury:aa1n7rdpqvgf37ktx30a2sv2kkszk3m7ncmakdj4g","description":"description"}}`
...
func TestMsgDeleteSuperGetSignBytes(t *testing.T) {
	msg := NewMsgDeleteSuper(testAddr, sender)
	res := msg.GetSignBytes()
	expected := `{"type":"gridiron/guardian/MsgDeleteSuper","value":{"address":"did:fury:aa1n7rdpqvgf37ktx30a2sv2kkszk3m7ncmakdj4g","deleted_by":"did:fury:aa1pgm8hyk0pvphmlvfjc8wsvk4daluz5tgwp4wlf"}}`
	require.Equal(t, expected, string(res))
}
