...
FURYhub metrics also contains tendermint metrics, Visit [tendermint metrics](https://github.com/furynet/tendermint/blob/furynet/master/docs/tendermint-core/metrics.md) for more information.
